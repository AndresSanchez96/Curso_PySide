from PySide6.QtWidgets import QMainWindow, QApplication, QSpinBox, QDoubleSpinBox, QSlider, QDial
...
class Componentes(QMainWindow):
    def __init__(self):
        ...
        # QDial es una rueda similar al slider, utilizado para apps de audio
        componente = QDial()
        componente.setRange(-5, 50)

        # Conectamos a las señale so eventos
